    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="fixed bottom-6 right-6 z-50">
                ...
                >
                    {isChatOpen ? <CloseIcon className="w-10 h-10"/> : <img src="https://i.imgur.com/U89oT1Y.png" alt="Abrir chat de asistente" className="w-20 h-20 rounded-full object-cover" />}
                </button>
            </div>
        </div>
    );
